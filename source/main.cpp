...
int main() {
	...
	while (aptMainLoop()) {
		...
		case 3:	//演奏画面
			...
			//タップエフェクト
			C2D_DrawRectangle(0 + (319.0 / Notes[checknote].keys * touchid),0,0,79.75,BOTTOM_HEIGHT,C2D_Color32(0xFF, 0xFF, 0xFF, 0x00),C2D_Color32(0xFF, 0xFF, 0xFF, 0x00),C2D_Color32(0xFF, 0xFF, 0xFF, 0xFF),C2D_Color32(0xFF, 0xFF, 0xFF, 0xFF));
